// @from https://www.shadertoy.com/view/3scfD7
// pixel shader
cbuffer cb0
{
	float2 iResolution;
...
//#define Resolution (iResolution.xy) // OLD
...
float4 main(float4 position : SV_POSITION) : SV_TARGET { 
    ...
    //N = mix(float3(0.0, 1.0, 0.0), N, 1.0 / (dist * dist * 0.01 + 1.0)); // OLD
    N = lerp(float3(0.0, 1.0, 0.0), N, 1.0 / (dist * dist * 0.01 + 1.0)); // NEW
